...
export default function Login({
  ...
  taglineTitle = 'Autonomous Sales Intelligence',
  taglineDesc = 'Deploy intelligent SDR agents that research prospects, personalize outreach, and book qualified meetings on autopilot.',
  onLoginSuccess,
} = {}) {
  // Auth mode
  ...
  const calcPos = (targetRef) => {
    if (!targetRef?.current) return { faceX: 0, faceY: 0, bodySkew: 0 }
